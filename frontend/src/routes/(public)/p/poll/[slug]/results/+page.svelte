...
<div class="max-w-2xl mx-auto">
	...
	{:else}
		<Card>
			{#snippet header()}
				<h2 class="text-lg font-medium text-gray-900 dark:text-gray-100">Vote Summary</h2>
			{/snippet}

			{#snippet children()}
				{#if tally.length === 0}
					<p class="text-gray-500 dark:text-gray-400 text-center py-4">No votes yet</p>
				{:else}
					<div class="space-y-4">
						{#each tally as t (t.option_id)}
							...
							<div class="p-4 bg-gray-50 dark:bg-neutral-800 rounded-lg">
								<div class="flex items-center justify-between mb-2">
									<span class="font-medium text-gray-900 dark:text-gray-100">Option {t.option_id}</span>
