...
{:else if bookingLinks.length === 0}
	<div class="text-center py-12">
		...
		<h3 class="mt-2 text-sm font-medium text-gray-900">No booking links</h3>
		<p class="mt-1 text-sm text-gray-500">Get started by creating a booking link for 1:1 scheduling.</p>
		<div class="mt-6">
			<Button variant="primary" onclick={() => (window.location.href = '/booking-links/new')}>
