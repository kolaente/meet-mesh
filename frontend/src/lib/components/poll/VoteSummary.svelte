...
<div class="space-y-2 {className}">
	...
	<div class="flex items-center gap-2">
		...
		<span class="w-8 text-xs font-medium text-gray-600 dark:text-gray-400 text-right">{counts.yes}</span>
	</div>
	...
	<div class="flex items-center gap-2">
		...
		<span class="w-8 text-xs font-medium text-gray-600 dark:text-gray-400 text-right">{counts.no}</span>
	</div>
	...
	<div class="flex items-center gap-2">
		...
		<span class="w-8 text-xs font-medium text-gray-600 dark:text-gray-400 text-right">{counts.maybe}</span>
	</div>
